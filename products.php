    ...
    <div class="row align-items-stretch main-body">
        <div class="col-lg-10 col-md-12" style="margin:10px;">
            <div class="generator-container">
                ...
                <p style="font-size:15px; padding-left: 10px; padding-right:10px;">You can follow the guidelines to generate Secure
                    QR code.</p><br>
                <div class="info-header" style=" 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size: 15px;color: #333;
            margin-bottom: 10px; font-weight:bold; margin-left:10px; ">
                    <p>Guidelines :</p>
                </div>
                <div style="margin-left:10px;  margin-right: 10px; margin-bottom: 10px;">

                    <small
                        style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-weight: normal; margin-top:20px; margin-bottom:20px; font-size: 15px; color:black; white-space: normal; word-break: break-word; align-items: left;">
                        1. Users need to upload contents whether text/url, image and pdf.<br>
                        2. System will verify the content with Malware Scanner API.<br>
                        3. User can design the foreground and background of QR Code.<br>
                        4. User can choose to enter the password or not for each QR Code.<br>
                        5. User need to click secure button whether they has design<br> and has option enter password for the QR
                        Code or not.<br>
                        6. User successfully finish the process of generating Secure & Trusted QR Code.<br><br>
                    </small>
                    <strong style="font-size: 15px;">Enjoy the process 😊</strong>
...
<form method="post" id="qrForm" enctype="multipart/form-data">
    <div class="tab-buttons" style="text-align: center;justify-content:center; align-items: center;">
        <button type="button" class="tab-button active" data-tab="textTab"><i class="fa fa-font"></i> Text/URL</button>
        <button type="button" class="tab-button" data-tab="pdfTab"><i class="fa fa-file-pdf"></i> PDF File</button>
        <button type="button" class="tab-button" data-tab="imageTab"><i class="fa fa-file-image"></i> Image File</button>
    </div>
    ...
    <div class="tab-content">
        ...
        <div id="pdfTab" class="tab-pane">
            <label for="pdfUpload" class="file-upload-wrapper"><br>
                ...
                <span id="pdfFileName" class="file-name-display">No file selected. File cannot exceed 40mb</span>
            </label>
        ...
        <div id="imageTab" class="tab-pane">
            <label for="imageUpload" class="file-upload-wrapper">
                ...
                <span id="imageFileName" class="file-name-display">No image selected. Image cannot exceed 40mb</span>
            </label>
    ...
    <div class="button-group-centered" style="gap:15px;">
        <button type="submit" name="generate_qr" id="generateBtn" class="btn" style="border-radius: 40px;">
